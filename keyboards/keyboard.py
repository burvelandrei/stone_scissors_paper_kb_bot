...
yes_button = KeyboardButton(text=LEXICON_RU['yes'])
no_button = KeyboardButton(text=LEXICON_RU['no'])
...
game_kb_builder.row(stone_button, scissors_button, paper_button, width=1)
